...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run the fixed ORED-3A composition NC grid.")
    ...
    parser.add_argument("--output-root", type=Path, default=Path("outputs/ored/o3a/formal"))
    ...
    for dataset, seed, variant in selected:
        ...
        command = [
            ...
            "model.score_hidden_dim=64",
            "model.composition_strength=0.5",
            "model.composition_temperature=1.0",
